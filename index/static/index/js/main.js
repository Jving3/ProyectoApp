...
function editarPreventivo(id, equipo, fecha, frecuencia, solicitado, estado, responsable, actividades, subtotalmo, supervisado) {
  ...
  document.getElementById("frecuencia_editar").value = frecuencia;
  document.getElementById("solicitado_editar").value = solicitado;
  ...
  document.getElementById("supervisadop_editar").value = supervisado;
